...
export class InventoryManager {
    ...
    public backpackSlot: any | null = null; // Placeholder for backpack item
    ...
    addAmmo(type: string, amount: number) {
        ...
        if (this.primaryWeapon && this.primaryWeapon.stats.ammoType === type) {
            ...
            console.log(`Added ${amount} ${type} to Primary Weapon`);
            ...
            console.log(`Added ${amount} ${type} to Secondary Weapon`);
        }
    }
}
